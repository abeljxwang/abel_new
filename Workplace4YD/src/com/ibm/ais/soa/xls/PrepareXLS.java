...
public class PrepareXLS {
	...
	public PrepareXLS(String filename) throws IOException {
	...
	public PrepareXLS(String filename, boolean write) throws IOException {
		short rownum = 0;
		...
		s
				.addMergedRegion(new Region((short) 0, (short) 0, (short) 3,
						(short) 3));
		s.addMergedRegion(new Region((short) 100, (short) 100, (short) 110,
				(short) 110));
	...
	public PrepareXLS(String infile, String outfile, boolean write)
			throws IOException {
		...
		if (args.length < 2) {
			...
			if (args[1].toLowerCase().equals("write")) {
				...
				try {
					...
					PrepareXLS hssf = new PrepareXLS(args[0], true);
				...
				try {
					PrepareXLS hssf = new PrepareXLS(args[0]);
