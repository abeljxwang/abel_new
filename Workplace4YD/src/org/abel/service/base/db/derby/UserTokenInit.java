		...
		try {
			...
			String tablename="";
			 ...
			 rs = metaData.getTables(null, "S_CONSOLE", "%", null);
				...
				rs = s.executeQuery("SELECT login_id, user_id,user_name FROM UserToken where login_id in ('admin','abeljxwang')");
				...
				rs.close();
				System.out.println("admin aocunt already exit.  id = "+adminid);
