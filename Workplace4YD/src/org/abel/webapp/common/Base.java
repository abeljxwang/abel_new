...
public class Base {
	...
	private void startConnect() throws ClassNotFoundException, SQLException{
		...
		String url = "jdbc:db2://localhost:50000/ABELDB";
	...
	public void checkAuthor() throws ClassNotFoundException, SQLException{
		String [] tmp = authorId.split("\\,");
		startConnect();
		//System.out.print("SELECT * FROM authors WHERE Id="+tmp[0]+"");
	...
	public void update() throws ClassNotFoundException, SQLException{
		checkAuthor();
		startConnect();
		System.out.println("UPDATE books SET instore="+instore+", name='"+name+"', authorid="+aId+", pubdate="+pubDate+", price="+price+" WHERE Id="+id+"");
