...
public class MVCSContainer extends javax.servlet.http.HttpServlet {
	...
	private static String PAGE_ERROR = "/jsp/common/error.jsp";
	private static String PAGE_LOGON = "/jsp/common/logon.jsp";
	private static String PAGE_INDEX = "/jsp/common/index.jsp";
	private static String PAGE_REFRESH = "/jsp/common/refresh.jsp";
	...
	static Logger logger = Logger.getLogger(MVCSContainer.class.getName());
	...
	public void performTask(
		...
		try {
			...
			if (functionstr == null) {
				...
				if (actionstr != null
					&& actionstr.equals("Login")) { //LOGIN/login
				...
				actionstr != null && actionstr.equals("ForwardAction")) {
				...
				if (ecfg.getFucntion(functionstr) == null) {
					...
					throw new WebAppException(
						"Function: [" + functionstr + "] not exsit");
					...
					if (fcfg.getAcction(actionstr) == null)
						...
						if (outstr == null) {
							...
							if(outstr == null) throw new WebAppException(
							...
							if (instancename != null
								...
								if (cname != null) {
									...
									while (skeys.hasMoreElements()) {
										String keytmp =
											skeys.nextElement().toString();
									session.setAttribute(
											keytmp,
											eres.getSResult(keytmp));
									}
//									
//									Enumeration rkeys = eres.getRResultNames();
//																		while (rkeys.hasMoreElements()) {
...
//									
			...
			String portlletbase = "/portlet/basepf.jsp";
	...
	private void setSessionRequest(
	HttpSession sessiontmp,
		Request ereq) {
	...
	public void init() {
		...
		try {
			...
			//			String rptcfgfile = getServletConfig().getInitParameter("dictPath");
			//			
			//			ecfg = new EIPConfig(prefix + rptcfgfile);
			//			
			//			dictPath
			...
			//Loging configration
			//String logcfgfile = getServletConfig().getInitParameter("logcfg");
