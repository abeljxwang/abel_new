...
<table border="0" width="100%" cellspacing="0" cellpadding="5">
	<tr>
		<td width=30%>数据库表名称： <%=sqltable%></td>
	...
	<tr>
			...
			<div>
				...
				<div id="result" class="boxcontent_1">
					<center>
						<div>
							<form method="POST"
								action="<portletAPI:createURI><portletAPI:URIAction name="insertElementBasic"/></portletAPI:createURI>">
								<table border=0 width=90% cellspacing="0" cellpadding="0"
									bgcolor=ffffff>
									<tr>
										<td align=left class="fieldName">ENAME<br>
										<input type=hidden name="EID" size=20>
											<input name="ENAME" size=20 class="form_field_1"></td>
									</tr>

									<tr>
									<td align=left class="fieldName">中文名<br>
									<input name="CNAME" size=20 class="form_field_1"></td>
									</tr>
									<tr>
										<td align=left class="fieldName">中文描述<br>
										<textarea name="elementdesc"class="form_field_textarea"></textarea></td>
									</tr>
									<tr>
										<td align=left class="fieldName">分类<br>
										<select name="DOMAINID" class="form_field_1">
												<option value="">未选择</option>
												<option value="COMM">电信</option>
												<option value="BANKING">金融[银行]</option>
												<option value="SECURITYS">金融[证券]</option>
												<option value="INSURANCE">金融[保险]</option>
												<option value="EXPRESS">快件</option>
												<option value="CIM">通用管理</option>
										</select></td></tr>
										<tr>
										<td>
										<INPUT class="ButtonType" type="submit"
											value=" 插入记录 " class="form_field_1"> &nbsp;</td>
									</tr>
								</table>
							</form>
		...
		<td width=50% rowspan=2 valign=top>
			<div>
				...
				<div>
					<form
							action="<portletAPI:createURI><portletAPI:URIAction name="queryME_List"/></portletAPI:createURI>">
							<table border=0>
								<tr>
									<%
										int sizea = cmd.size();
							...
							<td bgcolor=000055 width="100%">
										...
										<td align=right>
											<%
												...
												for (int i = 1; i <= page_len && i <= current_pg + 10; i++) {
													out.print("<a href='queryME_List?ENAME=" + ENAME + "&page_c="
															+ i);
													if (page_s != 10)
								...
								<table border="0" width="100%" cellspacing="1" cellpadding="1">
									...
									<%
										...
										out.print("<td bgcolor=bbbbff></td><td bgcolor=bbbbff></td></tr>");
										String message = null;
