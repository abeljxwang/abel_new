...
<link rel="StyleSheet" href="/Workplace4YD/theme/dtree.css"
	type="text/css" />
<script type="text/javascript" src="/Workplace4YD/js/dtree.js"></script>
...
<SCRIPT language=JavaScript type=text/javascript>
	...
	function putValue(cname,cid,fdesc,servlink)
	{
		...
		//FUNCID,UP_FUNCID,FUNCNAME,F_DESC,FUNC_LINK,CATALOG
              ...
              document.inputform.FUNC_LINK.value=servlink;
              document.inputform.F_DESC.value=fdesc;
              if(servlink==""){
              document.inputform.FUNC_LINK.value= "";
	...
	function onSubmitForm()
	{
 	  ...
 	  document.inputform.action ="/Workplace4YD/ET/FunctionTree/addC";
	...
	function addS2C()
	{
 	  ...
 	  document.inputform.action ="/Workplace4YD/ET/FunctionTree/addS2C";
 	  document.inputform.submit();
	  return true;
	}
	...
	function delS2C()
	{
 	  document.inputform.action ="/Workplace4YD/ET/FunctionTree/delS2C";
 	  document.inputform.submit();
	  return true;
	}
	...
	function info2C()	
	{
 	  document.inputform.action ="/Workplace4YD/ET/FunctionTree/serviceCard";
	...
	function onSubmitFormDel()
	{
 	  ...
 	  document.inputform.action ="/Workplace4YD/ET/FunctionTree/delC";
 	  document.inputform.submit();
	  return true;
	}	
	...
	{
 	  document.inputform.action ="/Workplace4YD/ET/FunctionTree/updateC";
 	  document.inputform.submit();
	  return true;
	}	
    //end add zdy 
	...
	if (setsize > 0) {
		...
		while (dbresult.next()) {
			...
			if(dbresult.getString(2)==null){
			   ...
			   out.print("\"javascript:selectSOption('-1');putValue('"+dbresult.getString(3)+"','"+dbresult.getString(1)+"','"+dbresult.getString(4)+"','"+dbresult.getString(5)+"');selectOption('"+dbresult.getString(2)+"');\"");
			   out.print(");");
			   //;");
			...
			if(dbresult.getString(1).equals("-1")){
			   ...
			   out.print("\"javascript:selectSOption('-1');putValue('"+dbresult.getString(3)+"','"+dbresult.getString(1)+"','"+dbresult.getString(4)+"','"+dbresult.getString(5)+"');selectOption('"+dbresult.getString(2)+"');\"");
			   out.print(",'','','/Workplace4YD/images/tree/folder.gif'");
			   out.print(");\n");
			   forseletop=forseletop+"<option value=\""+dbresult.getString(1)+"\">"+dbresult.getString(3)+"</option>\n";
			   //add zdy
...
%>
		...
		<table width=95%>
			<tr bgcolor=DDDDFF>
				<td>父类名称：</td>
				<td><select name="UP_FUNCID" id="up_catalog">
			...
			<tr bgcolor=DDFFDD>
				...
				<td>子类别名称:<br>
				<input name=FUNCNAME id=catalogname type=text size=20>
				<input name=FUNCID id=catalogid type=text size=20>
				<input name=FUNC_LINK id=FUNC_LINK type=text size=20>
				<input name=CATALOG id=CATALOG type=text size=20>

					
					<br>
					<textarea cols="50" rows="3" id="catalogesc" name="F_DESC"></textarea>
