...
//		}
	...
	/**
	 * Get the WSDL for specified transaction
	 * @param		transID		Transaction ID to be retrieved
	 */
	private Definition getTransWSDL(String transID) throws SOAPException {
		...
		try {
			...
			File wsdlFile =
				new File("C:/daijun/workspaces/workspaces/ccbcenter/demo1/Test/com/temp/services/TBJavaService.wsdl");
			Document wsdlDoc = builder.parse(wsdlFile);
			WSDLFactory wsdlFactory = WSDLFactory.newInstance();
			WSDLReader wsdlReader = wsdlFactory.newWSDLReader();
			definition = wsdlReader.readWSDL(null, wsdlDoc);
			return definition;
		} catch (Exception e) {

			throw new SOAPException("WSDL process error.", e);
		}
	}
