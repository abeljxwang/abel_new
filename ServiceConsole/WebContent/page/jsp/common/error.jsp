...
<table width="600" height="300" bgcolor="#dddddd" border="0"
	...
	<tr  bgcolor="#dddddd" >
		...
		<table border="0" width="100%" height=25 name="header"
			...
			<tr>
				...
				<TD></TD>
				<TD class="cat02" align=right>发生时间：<%=new java.util.Date()%> &nbsp;&nbsp;</TD>
			</tr>
		</table>
	...
	<tr  bgcolor="#dddddd" >
		...
		<table width="95%" cellpadding="0" cellspacing="0" border="0">
			<tr>
				<TD colspan="4" bgcolor="#e0e0e0" align=left>&nbsp;<font color=FF000000>Error Message:<br>
				<%out.print(eee.getMessage());%></font>
				<hr size=1 width=90%>
				</TD>
			</tr>
			<tr>
	...
	<tr>
		<td height="30" width="100%" bgcolor="#dddddd">
