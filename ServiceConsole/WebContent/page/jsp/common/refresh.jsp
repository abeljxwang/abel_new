...
<table width="600" height="300" bgcolor="#ffffff" border="0"
	...
	<tr>
		...
		<table border="0" width="100%" bgcolor="#99ddff"
			cellpadding="0" cellspacing="0">
			<tr>
	...
	<tr>
		...
		<table width="95%" cellpadding="0" cellspacing="1" border="1">
			...
			<tr>
				<TD colspan="4">&nbsp; <%EIPConfig ecfg = null;
...
<footermsgL>KMTC </footermsgL>
<footermsgC>--- </footermsgC>
<footermsgR>Page</footermsgR>
<outpage>
---></td>
			</tr></table>
	...
	<tr>
		...
		<TABLE width="100%" height="100%" bgColor=#99ddff border=0 cellpadding="0" cellspacing="0">
