...
HTMLstr += "<table width='190' cellspacing='0' cellpadding='0' border='1'>\n";
HTMLstr += "<tr><td bgcolor='darkblue'>\n";
HTMLstr += "\n";
HTMLstr += "<table border='0' cols='3' width='100%'>\n";
HTMLstr += "<tr>\n";
HTMLstr += "<td><b><font color='white'>年:</font></b></td>\n";
HTMLstr += "\n";
if (n)
{
...
HTMLstr += "</td></tr>\n";
HTMLstr += "\n";
HTMLstr += "<tr height='80px'><td valign=\"top\">\n";
HTMLstr += "\n";
HTMLstr += "<table border=0 cols=7 width='190px'>\n";
HTMLstr += "<tr>\n";
HTMLstr += "<td width=20><b>一</b></td>\n";
HTMLstr += "<td width=20><b>二</b></td>\n";
HTMLstr += "<td width=20><b>三</b></td>\n";
HTMLstr += "<td width=20><b>四</b></td>\n";
HTMLstr += "<td width=20><b>五</b></td>\n";
HTMLstr += "<td width=20><b>六</b></td>\n";
HTMLstr += "<td width=20><b>日</b></td>\n";
HTMLstr += "</tr>\n";
HTMLstr += "<tr>\n";
HTMLstr += "<td colspan=7>\n";
if (ie||ns6)HTMLstr += "<div style='position: relative;'>";
if (n) HTMLstr += "<ilayer id='idMenuContainer' height='100px' width='200px'>\n";
