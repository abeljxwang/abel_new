...
public class MsgObject {
    ...
    //add by mazhenmin
	HashMap<String, MsgBody> hmResp = new HashMap<String, MsgBody>();
    //add end
	...
	public HashMap<String, MsgBody> getAllResponses(){
		return hmResp;
	}
    //add end
...
*/
    public HashMap<String, String> getAllExtAttribute(String key){
