...
public class SQLParser 
{
   ...
   {
    if ( ( (sqltmp.trim()).toLowerCase()).equals("select")) {
      sql = "select ";
    }
    else if ( ( (sqltmp.trim()).toLowerCase()).equals("insert")) {
      sql = "insert into ";
    }
    else if ( ( (sqltmp.trim()).toLowerCase()).equals("delete")) {
      sql = "delete from ";
    }
    else if ( ( (sqltmp.trim()).toLowerCase()).equals("update")) {
      sql = "update ";
    }
    else {
      sql = sqltmp;
   ...
   public String setcdt(Properties sqlcdt) 
   {
    ...
    String strtmp = "";
    int i = sqlcdt.size();
    Enumeration<Object> ee = sqlcdt.keys();
