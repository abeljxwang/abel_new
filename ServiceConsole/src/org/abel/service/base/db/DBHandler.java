...
//					+ " and (KPICURFLAG=1) and (KPINAME ='��Ҫ���ҵ������')))  "
...
//			String sql15="SELECT UNIT from IS_DEVRPT where DEVRPTTYPE='Day'";
			...
			//dh.insert("insert into tmp (name) values('��ϸ')");
			//dh.insert("insert into test values ('��','dd',1,CURRENT DATE) ");
			dh.close();
		} catch (Exception se) {
			se.printStackTrace();
		}
