...
public class REST4JSONEngine extends REST4JSONEngineBase {
	...
	protected JSONObject onMessage(JSONObject reqDoc, String serviceid,
		...
		logger.info( df.format(dateobj )+"  Service Name: [" + serviceid +"], ");
		...
		if (opcfg != null)
			...
			logger.info("=========> No such operation:" + operationid + " under service:" + serviceid);
		}
		logger.info(" moodel: ["+ servmodelname+"], ");
		...
		logger.info(" CLASS NAME: [" + servmodelclass +"]\n");
