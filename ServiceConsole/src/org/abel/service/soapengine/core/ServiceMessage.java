...
public class ServiceMessage  {
	...
	public static void main(String[] t) throws Exception{
		...
		ServiceMessage sm=new ServiceMessage("query_Well_Info");
		sm.set("well_id", "1234");
		sm.set("well_id", "1234235");
		sm.set("location", "BeiJing");
		
		ServiceMessage sm2=new ServiceMessage("well_info");
		sm2.set("well_id", "1234");
		...
		envelope.addNamespaceDeclaration("q0", "http://www.cnpc.org/CNPC_Well_Mgr/");
		...
		System.out.println("--"+sm.getValues("well_id"));
