...
<script type="text/javascript"
	src="/MVC4CPF/js/error_mgr/errormgr_1.js"></script>
			...
			<tr>
				...
				<%
					...
					for (int i = pgtmpstart; i <= page_len && i <= pgtmpend; i++) {
						out.print("<a href='addErrorInfoForm?Error_Code=" + Error_Code
...
<script type="text/javascript">
	  document.inputform.Sys_ID.value ="<%=Sys_ID%>";	
		...
		<table border=0 width=95% cellspacing="0" cellpadding="0">
			<tr>
				<td align=left colspan=4>Error_Code: <input type=hidden name="Error_Code4I"  id="Error_Code4I"
					size=15 disabled><input type=text name="Error_Code" size=15 > 
					<input type="button" name="genECode" 
					onclick="autoEcodeRequest('/XMLEngine/XMLC/SysCatCode/codegen/','')" 
					value=" 自动生成错误码 " >
			...
			<tr>
				...
				<td align=left colspan=2>Error_Cat</td>

			</tr>

			<tr>
				<td align=left>
				<input type="hidden" name="Sys_ID4I" size=15 id="Sys_ID4I" disabled>
				<select name="Sys_ID" id="Sys_ID_1"
					onChange="getCatChain('/XMLEngine/XMLC/ErrorCode/codechainsys/');">
					<option value="0700">EAIH</option>
					<option value="0250">ECTIP</option>
					<option value="0140">CCI</option>
					<option value="0141">CSR</option>
			...
			<tr>
				<td align=center colspan=4><INPUT class="ButtonType"
					type="submit" value=" 插入记录 "> &nbsp;  &nbsp; <INPUT class="ButtonType"
