...
<script type="text/javascript">
	  document.inputform.Sys_ID.value ="<%=Sys_ID%>";	
		...
		<table border=0 width=95% cellspacing="0" cellpadding="0">
			...
			<tr>
			<td>
			<input type=text name="Error_Code4I" size=15 id="Error_Code4I" disabled><input type=hidden name="Error_Code" size=15>	
			</td>
				<td align=left>
				<input type=hidden  name="Sys_ID" id="Sys_ID_II" size=15>
				<input type="text" name="Sys_ID4I" size=15  id="Sys_ID4I" disabled>
				</td>
			...
			<tr>
				<td align=left>分类关系</td>
				<td align=left colspan=3>
				<input type=hidden  name="Sys_ID4MC" id="Sys_ID4MC" size=15>
				<select name="Cat_ID" id="Cat_ID">
				</select>
				<a href="javascript:getCatChain('/XMLEngine/XMLC/ErrorCode/codechainsys/');">
<span style='font-size:14.0pt;font-family:Webdings;
mso-ascii-font-family:"Times New Roman";mso-hansi-font-family:"Times New Roman";
color:red;mso-char-type:symbol;mso-symbol-font-family:Webdings'>&euml;</span>
</a>
				</td>
