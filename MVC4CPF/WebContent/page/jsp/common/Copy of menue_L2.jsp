...
<ul id="menuModel" style="display: none">
	<li id="100"><a>银行存款录入(F7)</a>
	<ul width="150">
		<li id="1023"><a href="<portletAPI:encodeURI path="/ET/View/queryErrorInfo" />">查询</a></li>
		<li id="10005" itemType="separator"></li>
		<li id="1024"><a href="<portletAPI:encodeURI path="/ET/View/exportErrorInfo" />">录入</a></li>
		<li id="1031"><a href="<portletAPI:encodeURI path="/ET/View/queryCatTree" />">复核</a></li>	
	</ul>
	</li>
